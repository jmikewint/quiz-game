...
const s = {
  ...
  input: { width:"100%", padding:"12px 14px", borderRadius:12, border:"1.5px solid #e2e8f0", fontSize:15, outline:"none", background:"#f8fafc", boxSizing:"border-box", marginBottom:10 },
